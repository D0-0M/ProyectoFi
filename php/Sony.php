...
//Consulta
$sql = "SELECT id, nombre, marca, precio, tipo, descripcion, imagen FROM producto WHERE marca = 'Sony'";
                ...
                <ul class="menu_horizontal">
                    <li><a href="">Productos</a>
                        <ul class="menu_vertical">
                            <li><a href="../php/Sony.php">Sony</a></li>
                            <li><a href="../php/EA.php">EA</a></li>
                            <li><a href="../php/SEGA.php">SEGA</a></li>
                            <li><a href="../php/Blizzard.php">Blizzard</a></li>
                        </ul>
                    </li>
