...
?>  
    ...
    <div class="nav-bg">
        <nav class="navegacion-principal contenedor">
            <section class="nav__izquierda">
                <a  href="../cliente/HomeUsuario.php"><img src="../icon/Toreto2.jpg" alt=""></a>
            </section>
    ...
    <div class="nav-marcas">
        <nav class="navegacion-marcas contenedor">
            <a href="../cliente/SonyCliente.php">Sony</a>
            <a href="../cliente/EACliente.php">EA</a>
            <a href="../cliente/SEGACliente.php">SEGA</a>
            <a href="../cliente/Blizzard.php">Blizzard</a>
        </nav>
    </div>
