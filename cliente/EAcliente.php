...
imagen FROM producto WHERE marca = 'EA'";
    ...
    <footer class="footer">
        <div class="footer__container">
          ...
          <div class="footer__column">
            ...
            <p><img src="../icon/icons8-gmail-32.png" alt="">  Email: Toreto@gmail.com</p>
            <h3>Nuestras Redes Sociales</h3>
            <p><img src="../icon/icons8-facebook-nuevo-32.png" alt="">  Facebook: Toreto212</p>
