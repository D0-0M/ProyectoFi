...
imagen FROM producto WHERE marca = 'Blizzard'";
...
<div class="nav-bg">
                ...
                <ul class="menu_horizontal">
                    <li><a href="">Productos</a>
                        <ul class="menu_vertical">
                            <li><a href="../cliente/SonyCliente.php">Sony</a></li>
                            <li><a href="../cliente/EACliente.php">EA</a></li>
                            <li><a href="../cliente/SEGACliente.php">SEGA</a></li>
                            <li><a href="../cliente/Blizzard.php">Blizzard</a></li>
                        </ul>
                    </li>
    ...
    <main class="contenedor">
        ...
        <h2 class="centrar-texto">Blizzard</h2>  
        <?php
    ...
    <footer class="footer">
        <div class="footer__container">
          <div class="footer__column">
            ...
            <p>
                En nuestra empresa Toreto vemos la privacidad de nuestros usuarios
          ...
          <div class="footer__column">
            ...
            <p><img src="../icon/icons8-gmail-32.png" alt="">  Email: mailtestD0.0M@gmail.com</p>
            <h3>Nuestras Redes Sociales</h3>
            <p><img src="../icon/icons8-facebook-nuevo-32.png" alt="">  Facebook: DOMINICTORETO</p>
            <p><img src="../icon/icons8-instagram-32 (1).png" alt="">  Instagram: DOMINICTORETO</p>
          </div>
        </div>
