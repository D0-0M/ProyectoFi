...
$resultado_carrito = $con->query($sql_carrito);
 ...
 and telefono = '$telefono' ";
    ...
    $pdf->Cell(0, 10, 'Este mensaje ha sido enviado por Toreto', 0, 1);
	...
	$mail->From = "mailtestD0.0M@gmail.com";
	$mail->IsSMTP();
	$mail->SMTPAuth = true;
    
	$mail->Username = "mailtestD0.0M@gmail.com";
    //$mail->Password = "qvolbvlxthjyiodr";
	$mail->Password = "qeys fuqm aomb buot";
	$mail->Port = 587;
